...
public class Info3 {
    ...
    public static class MapperImplementacaoATP3 extends Mapper<Object, Text, Text, IntWritable> {
        ...
        public static class ReducerImplementacaoATP3 extends Reducer<Text, IntWritable, Text, IntWritable>{
    ...
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException{
        ...
        String arquivoSaida = "/home2/ead2022/SEM1/henrique.guazzelli/Desktop/ATP/Informacao3";
        ...
        Job job = Job.getInstance(conf, "atividade3ATP");
        job.setJarByClass(Informacao3.class);
        job.setMapperClass(MapperImplementacaoATP3.class);
        job.setReducerClass(ReducerImplementacaoATP3.class);
