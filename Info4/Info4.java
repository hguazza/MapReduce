...
public class Info4 {
    ...
    public static class MapperImplementacaoATP4 extends Mapper<Object, Text, Text, IntWritable> {
        ...
        public static class ReducerImplementacaoATP4 extends Reducer<Text, IntWritable, Text, IntWritable>{
    ...
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException{
        ...
        String arquivoSaida = "/home2/ead2022/SEM1/henrique.guazzelli/Desktop/ATP/Informacao4";
        ...
        Job job = Job.getInstance(conf, "atividade4ATP");
        job.setJarByClass(Informacao4.class);
        job.setMapperClass(MapperImplementacaoATP4.class);
        job.setReducerClass(ReducerImplementacaoATP4.class);
