...
public class Info8 {
    ...
    public static class MapperImplementacaoATP8 extends Mapper<Object, Text, Text, LongWritable> {
        ...
        public void map(Object chave, Text valor, Context context) throws IOException, InterruptedException{
            ...
            if(campos.length == 10){                   
                ...
                Text chaveMap = new Text(mercadoria+"_"+ano);
        ...
        public static class ReducerImplementacaoATP8 extends Reducer<Text, LongWritable, Text, LongWritable>{
    ...
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException{
        ...
        String arquivoSaida = "/home2/ead2022/SEM1/henrique.guazzelli/Desktop/localResultsATP/Informacao8";
        ...
        Job job = Job.getInstance(conf, "atividade8ATP");
        job.setJarByClass(Informacao8.class);
        job.setMapperClass(MapperImplementacaoATP8.class);
        job.setReducerClass(ReducerImplementacaoATP8.class);
